...
class DifferTest {
    ...
    public void generateTest(String format) throws Exception {
        ...
        assertThat(Differ.generateAndFormat(filePath1, filePath2))
                .isEqualTo(resultStylish);
        // Json and Yaml to stylish
        assertThat(Differ.generateAndFormat(filePath1, filePath2, "stylish"))
                .isEqualTo(resultStylish);
        // Json and Yaml to plain
        assertThat(Differ.generateAndFormat(filePath1, filePath2, "plain"))
                .isEqualTo(resultPlain);
        // Json and Yaml to json
        assertThat(Differ.generateAndFormat(filePath1, filePath2, "json"))
